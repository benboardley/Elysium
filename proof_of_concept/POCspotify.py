...
class POCspotify:
    ...
    def __init__(self):
        ...
        self.scope = 'user-library-read user-top-read playlist-modify-private playlist-modify-public user-library-modify' # Take as argument l8r
        self.sp = None
    ...
    def add_playlist(self, playlist):
        ...
        self.add_songs(tracks,playlist_id)
